...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_aunorafiq/68024a398a31153971d7d462c0d57aa3/execroot/__main__',
    'ios_x86_64',
    {
        'ios_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/aunorafiq/Library/Application Support/Tulsi/0.20190501.88/Bazel',
